...
user1 = User.create(email: "q@q.ru", password: 123456)
user2 = User.create(email: "r@r.ru", password: 123456)

question1 = Question.create(title: "Почему?", body: "Почему?", user: user1)
question2 = Question.create(title: "Почемуже?", body: "Почему же?", user: user2)
